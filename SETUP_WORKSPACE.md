...
└── project-agent-config/
    ├── shared/
    │   └── CLAUDE.md           ← 전체 프로젝트 공통 대화 규칙 (workspace 루트에 심링크)
    └── {project-name}/
...
### 심링크 생성 명령 (workspace 공통 — 최초 1회)

```bash
# workspace 루트에 공통 CLAUDE.md 심링크
mklink "D:\workspace\CLAUDE.md" \
       "D:\workspace\docs\project-agent-config\shared\CLAUDE.md"
```
...
| 심링크 위치 | 소스 (docs) |
|-------------|----------------|
| `workspace/CLAUDE.md` | `project-agent-config/shared/CLAUDE.md` |
